...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
        ...
        <nav style="padding:0 10px" class="navbar navbar-expand-lg navbar-dark bg-primary">
            <a class="navbar-brand" href="#">IF GG</a>
            <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarText" aria-controls="navbarText" aria-expanded="false" aria-label="Toggle navigation">
                <span class="navbar-toggler-icon"></span>
            </button>
            <div class="collapse navbar-collapse" id="navbarText">
                <ul class="navbar-nav mr-auto">
                    <li class="nav-item"><a  class="nav-link" href="sass.html">Link 1</a></li>
                    <li class="nav-item"><a  class="nav-link" href="badges.html">Link 2</a></li>
                    <li class="nav-item"><a  class="nav-link" href="collapsible.html">Link 3</a></li>
                </ul>
            </div>
        </nav>
